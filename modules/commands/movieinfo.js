...
module.exports = {
  config: {
    name: "movieinfo",
    author: "ArYAN | AkhiroDEV",
    description: "Retrieve detailed information about a movie, including title, year, genre, plot, poster, vote average, vote count, popularity, original language, adult rating, backdrop image, runtime, director, cast, production companies, budget, revenue, tagline, homepage, production countries, and spoken languages.",
    usage: "{p}movieinfo [movie name] - Fetches and displays information about the specified movie.",
  },

  onRun: async function ({ api, event, args, message }) {
    try {
      if (args.length === 0) {
